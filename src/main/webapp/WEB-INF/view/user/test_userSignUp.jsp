              ...
              <div class="registration-form profile--form">
                <form action="/testUser1" method="get">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control item" id="nickname" placeholder="닉네임을 입력해주세요"
                         value="${not empty principal.nickname ? principal.nickname : ''}">
                        <div class="form-control item" id="email">
                        	${principal.email}
                        </div>
                        <input type="text" class="form-control item" id="phone" placeholder="휴대폰 번호를 입력해주세요"
                ...
                <div class="social-media">
                  <div class="form-group">
                    <button type="submit" class="btn btn-block create--account" onclick="validateSignUpProfile()">회원가입</button>
                </div>
                </div>
            </div>
            </div>
