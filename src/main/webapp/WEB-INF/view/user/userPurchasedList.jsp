									...
									<div class="card-body purchased--info">
										...
										<p class="card-text purchase-date">
											<small class="text-body-secondary"> <fmt:formatDate
													value="${purchaseProductInfo.paymentDate}"
										...
										<button type="button"
											class="btn btn-primary purchased--review--btn"
														...
														<div class="content-text p-4">
															...
															<form action="#" id="send--review--form">
																<input type="text" id="review--product--id"
																	...
																	플랜 : <a href="">${purchaseProductInfo.productTitle}</a>
																</span>
																<p>
																	구매하신 플랜에 대해 리뷰 작성을 해주세요! <br /> 해당 리뷰는 다른 플랜 구매자에게 큰
																	도움이 될 수 있습니다
																</p>
																<div class="form-group review--group">
																	<label for="review--register--title">리뷰 제목</label> <input
																		type="text"
																...
																<div class="form-group review--group">
																	<label for="review--register--content">리뷰 내용</label> <input
																		type="text"
