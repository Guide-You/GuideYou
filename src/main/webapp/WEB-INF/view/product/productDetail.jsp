        ...
        <div class="carousel-inner">
            ...
            <c:forEach items="${imgList}" var="img" varStatus="loop">
                <div class="carousel-item ${loop.index == 0 ? 'active' : ''}">
                    <img class="d-block w-100" src="/images/upload/${img.uploadFileName}" alt="Slide ${loop.index + 1}">
                </div>
            </c:forEach>
        </div>
...
<form id="send--detail--form">
	...
	<!-- 추후 photo 정보 받아오기 -->
	<input type="hidden" name="productTitle" id="product--title"
		value="${product.productTitle}">
	<!-- 추후 user nickname으로 변경 -->
	<input type="hidden" name="productSeller" id="product--seller"
		value="${product.userId}"> <input type="hidden"
...
<!-- Detail Image Start -->
<div class="d-flex">
	<form action="/delete/${productBtn.productId}" method="post">
		<button class="btn btn-danger">삭제</button>
	</form>
	<a href="/update/${id.productId}">
         ...
         <div class="carousel-inner">
            <c:forEach items="${reviewList}" var="rev" varStatus="loop">
               ...
               <div class="col-md-4 mb-4">
                  ...
                  <h5 class="mb-3">${rev.name}</h5>
                  <h6 class="text-primary mb-3">${rev.createdAt}</h6>
                  <p class="px-xl-3 text-center"> <!-- Modified: Center align the content -->
                     <i class="fas fa-quote-left pe-2"></i>${rev.content}
                  </p>
