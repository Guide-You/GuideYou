...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Board List 출력테스트중입니다</title>
    ...
    <body>
        ...
        <div class="container-fluid page-header py-5">
            <h1 class="text-center text-white display-6">notice list 고객용</h1>
            <ol class="breadcrumb justify-content-center mb-0">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item"><a href="#">Pages</a></li>
                <li class="breadcrumb-item active text-white">notice list 고객용</li>
            </ol>
        </div>
        <!-- Header End -->
        <!-- 게시물 리스트 -->
