					...
					<div class="col-lg-12">
						<form action="/company/boardInsert" method="post" id="insert">
							...
							<textarea class="w-100 form-control border-0 mb-4" name="content"
								rows="5" cols="10" placeholder="내용을 입력해주세요"
								style="resize: none; height: 400px;"></textarea>
							<div class="row justify-content-center">
								<div class="col-lg-4">
									<div class="d-flex">
										<button
											class="btn form-control border-secondary py-3 bg-white text-primary me-3"
											type="submit">취소</button>
										<button
											class="btn form-control border-secondary py-3 bg-white text-primary"
											type="submit" value="등록">등록하기</button>
									</div>
								</div>
							</div>
						</form>
