            ...
            <div class="container py-5">
                <div class="p-5 bg-light rounded">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-12">
                            <form action="/company/boardModify/${board.id}" method="post" id="updateById">
                                <input type="text" name="writerId" class="w-100 form-control border-0 py-3 mb-4" placeholder="${board.writerId}">
